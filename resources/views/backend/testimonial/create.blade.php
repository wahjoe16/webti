            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jurusan_angkatan') is-invalid @enderror" id="jurusan_angkatan" name="jurusan_angkatan" placeholder="Example: Teknik Industri - 1990">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="7" placeholder="Testimonial here..."></textarea>
                        @error('content')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('position') is-invalid @enderror" id="position" name="position" placeholder="Example: Manager Keuangan">
                        @error('position')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
