...
<form action="{{ route('histories.update', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-lg-9">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror ckeditor" id="description" name="description" rows="7" placeholder="Enter Description here...">{{ $data->description }}</textarea>
                        @error('description')
