...
<form action="{{ route('greetings.store') }}" method="POST" enctype="multipart/form-data">@csrf
    <div class="row">
        <div class="col-lg-9">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('message') is-invalid @enderror" id="message" name="message" rows="7" placeholder="Message here..."></textarea>
                        @error('message')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
