            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group mb-5">
                        ...
                        <input type="file" class="dropify @error('image_1') is-invalid @enderror" id="image_1" name="image_1" data-default-file="{{ url('/media/visi-misi/', $data->image_1) }}">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="file" class="dropify @error('image_2') is-invalid @enderror" id="image_2" name="image_2" data-default-file="{{ url('/media/visi-misi/', $data->image_2) }}">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="file" class="dropify @error('image_3') is-invalid @enderror" id="image_3" name="image_3" data-default-file="{{ url('/media/visi-misi/', $data->image_3) }}">
