            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('caption') is-invalid @enderror" id="caption" name="caption" rows="7" placeholder="Enter banner caption here...">{{ $data->caption }}</textarea>
                        @error('caption')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('link') is-invalid @enderror" id="link" name="link" value="{{ $data->link }}" placeholder="Enter banner link">
                        @error('link')
                            <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
